...
namespace LatihanADONET
{
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try
            {
                string dbName = @"E:\22.11.4800\pertemuan8\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void txtNpmUpdate_TextChanged(object sender, EventArgs e)
        {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result > 0)
            {
                MessageBox.Show("Data mahasiswa berhasil didelete !", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                // reset form
                txtNpmDelete.Clear();
                txtNamaDelete.Clear();
                ...
                MessageBox.Show("Data mahasiswa gagal didelete !!!", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                conn.Dispose();
        }
    }
}
